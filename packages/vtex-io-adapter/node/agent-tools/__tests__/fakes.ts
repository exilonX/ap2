...
import { FakeCheckoutClient, makeEmptyOrderForm, makeItem } from '../../cart/__tests__/fake-checkout';
 ...
 */
export function makeFakeToolContext(opts: {
  ...
  const ctx: ToolContext = {
    ...
    clients: { checkout, vbase } as unknown as ToolContext['clients'],
    config: MIN_CONFIG,
    orderFormId: opts.orderFormId === undefined ? 'of-test-1' : opts.orderFormId,
  };
  return { ctx, checkout, vbase };
}
